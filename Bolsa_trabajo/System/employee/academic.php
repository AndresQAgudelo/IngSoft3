...
<head>
	...
	<title>Calificaciones Academicas</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span>Calificaciones Academicas</span></li>
					</ol>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2>Calificaciones Academicas</h2>
									...
									<a href="app/drop-academic.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this qualification ?')" class="btn btn-primary btn-sm btn-inverse">Eliminar</a>
									...
									<option <?php if ($level == "Advanced Diploma") { print ' selected '; } ?> value="Advanced Diploma">Diploma Nivel Avanzado</option>
                                    <option <?php if ($level == "Advanced Level (ACSE)") { print ' selected '; } ?>  value="Advanced Level (ACSE)">Nivel Avanzado (ACSE)</option>
                                    <option <?php if ($level == "Certificate") { print ' selected '; } ?>  value="Certificate">Certificado</option>
                                    ...
                                    <option <?php if ($level == "Master Degree") { print ' selected '; } ?>  value="Master Degree">Grado Master</option>
                                    <option <?php if ($level == "Ordinary Level (CSE)") { print ' selected '; } ?>  value="Ordinary Level (CSE)">Nivel Ordinario (CSE)</option>
                                    <option <?php if ($level == "PHd") { print ' selected '; } ?>  value="PHd">PHd</option>
                                    <option <?php if ($level == "Post Graduate Diploma") { print ' selected '; } ?>  value="Post Graduate Diploma">Diploma Post Grado</option>
								...
								?>
				                    ...
				                    <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title text-center">Agregar Calificaciones Academicas</h4>
				                    </div>
									...
									<select name="level" required class="selectpicker show-tick form-control" data-live-search="false">
									<option disabled value="">Seleccionar</option>
									<option value="Advanced Diploma">Diploma Nivel Avanzado</option>
                                    <option value="Advanced Level (ACSE)">Nivel Avanzado (ACSE)</option>
                                    <option value="Certificate">Certificado</option>
                                    <option value="Degree">Grado</option>
                                    <option value="Diploma">Diploma</option>
                                    <option value="Master Degree">Grado Master</option>
                                    <option value="Ordinary Level (CSE)">Nivel Ordinario (CSE)</option>
                                    <option value="PHd">PHd</option>
                                    <option value="Post Graduate Diploma">Diploma Post Grado</option>
							        ...
							        <div class="form-group"> 
								    <label>Titulo del Curso</label>
								    <input class="form-control" placeholder="Ingresa Nombre del Curso" type="text" name="course" required> 
							        </div>
